...
@app.route('/')
def index():
    return "API de Transcrição de Áudio para Reuniões"
...
def transcribe_audio():
    ...
    try:
        # Enviar para a API Whisper da OpenAI
...
def analyze_transcription():
    ...
    try:
        # Usar a API da OpenAI para analisar a transcrição e extrair insights
